...
mappings.n["J"] =
    { cmd = ":move +1<CR>", opts = opts, desc = "Move lines down" }
...
mappings.i["<C-z>"] =
    { cmd = "<Esc>:u<Return>i", opts = opts, desc = "Undo changes" }
mappings.n["<C-y>"] =
    { cmd = "<C-R><Return>", opts = opts, desc = "Redo changes" }
mappings.v["<C-y>"] =
    { cmd = "<C-R><Return>", opts = opts, desc = "Redo changes" }
mappings.i["<C-y>"] =
    { cmd = "<Esc><C-R><Return>i", opts = opts, desc = "Redo changes" }
