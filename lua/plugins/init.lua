require("lazy").setup {
    ...
    -- ======================
        ...
        --[[ Friend. Snippets ]]{ "rafamadriz/friendly-snippets" },
        ...
        -- ==================
            --[[ Mason ]]       { "williamboman/mason.nvim" },
                                ...
                                { "jay-babu/mason-null-ls.nvim", event = "VeryLazy" , dependencies = { { "jose-elias-alvarez/null-ls.nvim" } } },
        ...
        --      Debugging
        -- ==================
            --[[ Adapter ]]     { "jay-babu/mason-nvim-dap.nvim", event = "VeryLazy", opts = { handlers = {} }, dependencies = {  "williamboman/mason.nvim", "mfussenegger/nvim-dap" } },
            --[[ Ui ]]          { "rcarriga/nvim-dap-ui", dependencies = { "mfussenegger/nvim-dap" } },
            --[[ Inline Hints ]]{ "theHamsta/nvim-dap-virtual-text" },
            --[[ REPL Cmp ]]    { "rcarriga/cmp-dap" },
            --[[ REPL Highlig.]]{ "LiadOz/nvim-dap-repl-highlights" },
    },
    -- options
    {
    }
